...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("which color had the most birds?", "100px 'Zerove'", "#FFFFFF");
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text(" watch the birds as they fly by. ", "100px 'Zerove'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 116;
	this.text.lineWidth = 1054;
	this.text.parent = this;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("let's do\nthis!", "200px 'Zerove'", "#FFFFFF");
	this.text.textAlign = "center";
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.text = new cjs.Text("mission solved.", "40px 'Zerove'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 48;
	this.text.lineWidth = 1276;
	this.text.parent = this;
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(686).to({_off:false},0).wait(16).to({y:-99.15},10,cjs.Ease.get(-1)).to({y:-5950.3},21).to({y:-8824.05},46,cjs.Ease.get(1)).to({_off:true},17).wait(1002));
