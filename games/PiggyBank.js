...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
...
}).prototype = getMCSymbolPrototype(lib.questiontext, new cjs.Rectangle(-475.4,-190,950.8,302.2), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-0.05,-63.6);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.instructionstext, new cjs.Rectangle(-408.4,-214.7,816.7,302.2), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
...
}).prototype = getMCSymbolPrototype(lib.answerrevealtext, new cjs.Rectangle(-241.6,-416.6,483.2,371.70000000000005), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(0,-230.75);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.answerrevealtext_1, new cjs.Rectangle(-241.6,-416.6,483.2,371.70000000000005), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(65.95,-127.25);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._3answerreveal, new cjs.Rectangle(-120.1,-304.7,372.1,355), null);
...
p.nominalBounds = new cjs.Rectangle(-738.1,-434.1,1476.3000000000002,1283.7);
...
}).prototype = getMCSymbolPrototype(lib.letsseehowyoudid, new cjs.Rectangle(-607.7,-435.8,1279.5,721.8), null);
...
p.nominalBounds = new cjs.Rectangle(-738.1,-434.1,1476.3000000000002,1260.1);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#666666","#333333"],[0,1],4,-113.9,4,345.9).s().p("Ehk/A4ZMAAAhwxMDJ/AAAMAAABwxg");
	this.shape_2.setTransform(32.05,-46.925);
...
}).prototype = getMCSymbolPrototype(lib.letsseehowyoudid_1, new cjs.Rectangle(-614.3,-407.8,1292.8,721.8), null);
...
}).prototype = getMCSymbolPrototype(lib.slotanswerreveal2ndroundcopy2, new cjs.Rectangle(-679.9,-554.1,1362.6,11472.1), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(41.025,57.825);
...
p.nominalBounds = new cjs.Rectangle(-680.1,-10383.5,1362.6,21469.2);
...
p.nominalBounds = new cjs.Rectangle(-680.1,-11107.5,1362.6,22193.2);
...
}).prototype = getMCSymbolPrototype(lib.slotanswerreveal, new cjs.Rectangle(-646.3,-527.6,1292.8,12253), null);


// stage content:
(lib.PiggyBank = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.actionFrames = [0,606,614,650,748,760,854,858,869,1475,1483,1519,1609,1613,1710,1726];
	// timeline functions:
	this.frame_0 = function() {
		this.stop();
	...
	this.frame_614 = function() {
		this.submitbtn.addEventListener("click", function (event) {
			...
			if (val.toLowerCase().trim() === "19" ||
				 val.toLowerCase().trim() === "nineteen" ||
				 val.toLowerCase().trim() === "Nineteen") {
	...
	this.frame_748 = function() {
		this.copyemoji1.addEventListener("click", function (event) { 
			...
			const textToCopy = `Vizulation "Piggy Bank"\n🎯`; 
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(606).call(this.frame_606).wait(8).call(this.frame_614).wait(36).call(this.frame_650).wait(98).call(this.frame_748).wait(12).call(this.frame_760).wait(94).call(this.frame_854).wait(4).call(this.frame_858).wait(11).call(this.frame_869).wait(606).call(this.frame_1475).wait(8).call(this.frame_1483).wait(36).call(this.frame_1519).wait(90).call(this.frame_1609).wait(4).call(this.frame_1613).wait(97).call(this.frame_1710).wait(16).call(this.frame_1726).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},744).to({state:[{t:this.instance}]},3).to({state:[{t:this.copyemoji1}]},1).to({state:[]},13).to({state:[{t:this.instance}]},93).to({state:[{t:this.instance}]},3).to({state:[{t:this.copyemoji2}]},1).to({state:[]},12).to({state:[{t:this.instance}]},739).to({state:[{t:this.instance}]},3).to({state:[{t:this.copyemoji2}]},1).to({state:[]},1).to({state:[{t:this.instance}]},92).to({state:[{t:this.instance}]},3).to({state:[{t:this.copyemoji2}]},1).wait(17));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(744).to({_off:false},0).to({alpha:1},3,cjs.Ease.get(1)).to({_off:true},1).wait(106).to({_off:false,alpha:0},0).to({alpha:1},3,cjs.Ease.get(1)).to({_off:true},1).wait(751).to({_off:false,alpha:0},0).to({alpha:1},3,cjs.Ease.get(1)).to({_off:true},1).wait(93).to({_off:false,alpha:0},0).to({alpha:1},3,cjs.Ease.get(1)).to({_off:true},1).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1614).to({_off:false},0).wait(113));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1520).to({_off:false},0).to({_off:true},94).wait(113));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(761).to({_off:false},0).wait(16).to({y:-99.15},10,cjs.Ease.get(-1)).to({y:-5950.3},21).to({y:-9542.55},46,cjs.Ease.get(1)).to({_off:true},16).wait(857));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(651).to({_off:false},0).wait(16).to({y:-99.15},10,cjs.Ease.get(-1)).to({y:-5950.3},21).to({y:-8822.7},46,cjs.Ease.get(1)).to({_off:true},17).wait(966));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_5}]},606).to({state:[{t:this.instance_5}]},7).to({state:[{t:this.submitbtn}]},1).to({state:[]},37).to({state:[{t:this.instance_5}]},824).to({state:[{t:this.instance_5}]},7).to({state:[{t:this.submitbtn2}]},1).to({state:[]},37).wait(207));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(606).to({_off:false},0).to({y:426.25},7,cjs.Ease.get(1)).to({_off:true},1).wait(861).to({_off:false,y:31.25},0).to({y:426.25},7,cjs.Ease.get(1)).to({_off:true},1).wait(244));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(606).to({_off:false},0).to({y:335.85},7,cjs.Ease.get(1)).wait(1).to({y:336.4},0).to({_off:true},37).wait(824).to({_off:false,y:-59.15},0).to({y:335.85},7,cjs.Ease.get(1)).wait(1).to({y:336.4},0).to({_off:true},37).wait(207));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7}]},1).to({state:[]},143).to({state:[{t:this.instance_8}]},340).to({state:[{t:this.instance_9}]},122).to({state:[]},45).to({state:[{t:this.instance_7}]},219).to({state:[]},143).to({state:[{t:this.instance_8}]},340).to({state:[{t:this.instance_9}]},122).to({state:[]},45).wait(207));

	// CSS
	this.instance_10 = new lib.an_CSS({'id': 'instance_10', 'href':'/assets/style.css'});

	this.instance_10.setTransform(438.65,-674.3,1,1,0,0,0,50,11);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({_off:true},1520).wait(207));
	...
	// Layer_22
	this.instance_11 = new lib.silvercoin();
	this.instance_11.setTransform(576.2,-80.85,0.7641,0.7641,0,0,0,0.1,0.2);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1108).to({_off:false},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(44).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(4).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(29).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(3).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(17).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(2).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(32).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(3).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(29).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(386));

	// Layer_18
	this.instance_12 = new lib.goldcoin();
	this.instance_12.setTransform(575.45,-65.4,0.8491,0.8491,0,0,0,0.1,0.1);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(1034).to({_off:false},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(14).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(10).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(13).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(33).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(13).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(27).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(3).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(3).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(21).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(2).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(18).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(2).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(2).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(2).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(19).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(1).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(1).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(1).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).to({_off:true},187).wait(207));

	// Layer_10
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#EBA0AE").ss(1,1,1).p("");
	...
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FDDADF").s().p("AgBgDIAEACIgDADIgCACgAAAACgAADgBIAAABIgDACg");
	this.shape_7.setTransform(675.425,184.025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4}]},870).to({state:[]},650).to({state:[]},1).wait(206));
	...
	// Layer_11
	this.instance_13 = new lib.blurshade();
	this.instance_13.setTransform(594.55,419.15);
	this.instance_13._off = true;
	this.instance_13.filters = [new cjs.BlurFilter(15, 15, 1)];
	this.instance_13.cache(-346,-274,693,548);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(870).to({_off:false},0).to({_off:true},650).wait(207));
	...
	this.instance_14.setTransform(642.15,438.1);
	this.instance_14.alpha = 0.8516;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(870).to({_off:false},0).to({_off:true},650).wait(207));

	// Layer_21
	this.instance_15 = new lib.shadowshade();
	this.instance_15.setTransform(580.8,638.3);
	this.instance_15._off = true;
	this.instance_15.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance_15.cache(-303,-67,606,134);
	...
	this.instance_16.setTransform(657.75,585.4);
	...
	this.instance_17.setTransform(452.4,279.05,0.7997,0.7997);
	this.instance_17._off = true;
	this.instance_17.filters = [new cjs.BlurFilter(10, 10, 1)];
	this.instance_17.cache(-614,-395,2086,733);
	...
	// Layer_22
	this.instance_18 = new lib.silvercoin();
	this.instance_18.setTransform(576.2,-80.85,0.7641,0.7641,0,0,0,0.1,0.2);
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(239).to({_off:false},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(44).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(4).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(29).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(3).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(17).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(2).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(32).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(3).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(29).to({_off:false,x:576.2,y:-80.85},0).to({x:556.65,y:247.6},6).to({_off:true},1).wait(1255));

	// Layer_18
	this.instance_19 = new lib.goldcoin();
	this.instance_19.setTransform(575.45,-65.4,0.8491,0.8491,0,0,0,0.1,0.1);
	this.instance_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(165).to({_off:false},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(14).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(10).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(13).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(33).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(13).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(27).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(3).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(3).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(21).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(2).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(18).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(2).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(2).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(2).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(19).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(1).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(1).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).wait(1).to({x:575.45,y:-65.4},0).to({x:554.9,y:260.9},6,cjs.Ease.get(1)).to({_off:true},187).wait(1076));

	// Layer_30
	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f().s("#EBA0AE").ss(1,1,1).p("");
	...
	this.shape_30.graphics.f("#FDDADF").s().p("AgBgDIAEACIgDADIgCACgAAAACgAADgBIAAABIgDACg");
	...
	this.shape_31.graphics.f().s("#FAA0AE").ss(0.1,1,1).p("AubBXIBzicQEtg3ExgEQIzgGIvBMIAFACIAAABIgFADIgCACIjdCzAOYg0IAFgE");
	...
	// Layer_11
	this.instance_20 = new lib.blurshade();
	this.instance_20.setTransform(594.55,419.15);
	this.instance_20._off = true;
	this.instance_20.filters = [new cjs.BlurFilter(15, 15, 1)];
	this.instance_20.cache(-346,-274,693,548);

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(1).to({_off:false},0).to({_off:true},650).wait(1076));
	...
	this.shape_35.graphics.f().s("#EBA0AE").ss(0.1,1,1).p("");
	...
	this.shape_43.graphics.f().s("#FAA0AE").ss(0.1,1,1).p("AEPIAQA8iNAqiRQAziyAJi2QAKjOhyioQi+gsivBTQhLAkhIAnQiJBMhxBtID6HBAE9n0QiOBjhzCEQhzCGhFChQgsBngPBvIHCEXIABAAIgCADQAEACAFAAIgEgMIgDAHIAHAF");
	...
	this.instance_21.setTransform(642.15,438.1);
	this.instance_21.alpha = 0.8516;
	this.instance_21._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(1).to({_off:false},0).to({_off:true},650).wait(1076));

	// Layer_21
	this.instance_22 = new lib.shadowshade();
	this.instance_22.setTransform(580.8,638.3);
	this.instance_22._off = true;
	this.instance_22.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance_22.cache(-303,-67,606,134);

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(1).to({_off:false},0).to({_off:true},650).wait(1076));

	// Layer_14
	this.instance_23 = new lib.table();
	this.instance_23.setTransform(657.75,585.4);
	...
	this.instance_24.setTransform(452.4,279.05,0.7997,0.7997);
	this.instance_24._off = true;
	this.instance_24.filters = [new cjs.BlurFilter(10, 10, 1)];
	this.instance_24.cache(-614,-395,2086,733);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_25).to({_off:true},1).wait(1726));
	this.timeline.addTween(cjs.Tween.get(instance_25Filter_1).wait(1726));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(479.5,-10387.7,1188.1,22640.800000000003);
// library properties:
lib.properties = {
