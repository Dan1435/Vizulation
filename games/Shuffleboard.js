...
lib.ssMetadata = [
		{name:"Shuffleboard_atlas_1", frames: [[0,0,2000,2000]]},
		{name:"Shuffleboard_atlas_2", frames: [[0,0,900,700],[0,702,786,441]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.concretewall, null, new cjs.Matrix2D(1,0,0,1.187,-658,-3136.8)).s().p("EhYnA7FMAABh2JMCxOAAAMAAAB2Jg");
	this.shape.setTransform(-1934.0375,1085.825);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.texture2, new cjs.Rectangle(-2501.2,707.8,1134.3999999999999,756.2), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-1.225,-96.625);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.questiontext2, new cjs.Rectangle(-484.2,-190,966,186.8), null);
...
(lib.platformalpha2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("EgDWg31IGtAAMAAABvrImtAAg");
	this.shape.setTransform(0,874.2125);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.platformalpha2, new cjs.Rectangle(-21.5,516.9,43,714.6999999999999), null);
...
(lib.suffleedge3 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_4
	this.instance = new lib.platformalpha2();
	this.instance.setTransform(1172.5,-12.75);
	this.instance.alpha = 0.6992;

	this.instance_1 = new lib.platformalpha2();
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("EgDWg79IGtAAMAAAB37ImtAAg");
	mask.setTransform(0,887.925);

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(img.abstractsurfacewoodtexturebackground, null, new cjs.Matrix2D(1,0,0,1.43,-1333.5,-3041.9)).s().p("EhlIA7+MgABh37MDKTAAAMAAAB37g");
	this.shape.setTransform(601.55,887.9125);
	...
	// Layer_1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("EgDWg79IGtAAMAAAB37ImtAAg");
	this.shape_1.setTransform(0,887.925);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	// Layer_5
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.149)").s().p("EgDWA7+MAAAh37IGtAAMAAAB37g");
	this.shape_2.setTransform(14.9,887.9125);

	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.suffleedge3, new cjs.Rectangle(-21.5,504.1,1215.5,767.6999999999999), null);
...
if (reversed == null) { reversed = false; }
	...
	// puck
	this.instance = new lib.bluepuck();
	this.instance.setTransform(19.85,-658.8,0.1308,0.1308);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(181).to({_off:false},0).to({x:-70.55,y:-782.6},15,cjs.Ease.get(1)).wait(361));

	// texture
	this.instance_1 = new lib.texture2();
	this.instance_1.setTransform(1932,-60);
	...
	// Layer_6
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(3,1,1).p("EAPQgw8Ig9g/EBNxgw8IAZAAEBOKgx7IAAA/Ig1g/EBNxgw8IAACKEAPQgw8MA+hAAAEhKigx7IgvA5EhQygw8IgBAAIAAgGQABgdABgcEhQyguyIAAiKMBE+AAAIbEAAEgK6gx7Ig6A/EBQ0guyMAAABguMiejAAAMAAAhgu");
	this.shape.setTransform(-23.8,1046.775);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#51A04C").s().p("EhNvAx8MAAAhguIjCAAIAAiKIgCAAIAAgGIACg5IGPAAIgvA5IAvg5MA/oAAAIg6A/MhE9AAAMBE9AAAIbDAAMA+iAAAMg+iAAAIg8g/MA/CAAAIA1AAIAAA/Ig1g/IA1A/IgZAAIAACKIDDAAMAAABgugEgL0gw8IA6g/IZNAAIA8A/gEhKigx7g");
	this.shape_1.setTransform(-23.8,1046.775);
...
p.nominalBounds = new cjs.Rectangle(-569.2,-836.3,1134.4,2240.3);
...
(lib.boardwithtexture2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_8
	this.instance = new lib.suffleedge3();
	this.instance.setTransform(588.6,496.95,1,1,0,0,180);

	this.instance_1 = new lib.suffleedge3();
	this.instance_1.setTransform(-584.1,524.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).to({state:[]},1).wait(729));

	// puck
	this.instance_2 = new lib.puck();
	this.instance_2.setTransform(15,1510.6,0.1612,0.1612);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:true},1).wait(729));

	// board
	this.instance_3 = new lib.board2();
	this.instance_3.setTransform(19.15,174,1.1821,1.1821,0,0,0,0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true},1).wait(729));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-660.3,0,1347.4,1833.7);
...
if (reversed == null) { reversed = false; }
	...
	// board
	this.instance_1 = new lib.boardwithtexture2("synched",0);
...
}).prototype = getMCSymbolPrototype(lib.newthumbnail, new cjs.Rectangle(-691.5,-489.7,1416.3,1032.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_25.cache(-693,-492,1420,1036);
...
p.nominalBounds = new cjs.Rectangle(-440.2,-10361,6748,22614.1);
// library properties:
lib.properties = {
