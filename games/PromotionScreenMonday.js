...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#2F2F2F").s().p("");
	this.shape.setTransform(94.3,-1.55);
	...
	this.shape_2.graphics.f("#2F2F2F").s().p("");
	this.shape_2.setTransform(-1.525,-29.925);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.info, new cjs.Rectangle(-208.5,-78.4,414,156.9), null);
...
// stage content:
(lib.PromotionScreenMonday = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
