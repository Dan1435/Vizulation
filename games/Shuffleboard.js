...
if (reversed == null) { reversed = false; }
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FFFFFF").ss(3,1,1).p("");
	this.shape_2.setTransform(-28.9,-798.825);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#51A04C").s().p("");
	...
	// Layer_6
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#FFFFFF").ss(3,1,1).p("");
	this.shape_5.setTransform(-23.8,650.025);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#51A04C").s().p("");
