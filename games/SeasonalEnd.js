...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(15.85,59.25);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#2F2F2F").s().p("");
	this.shape_1.setTransform(0.025,-25.55);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.info2, new cjs.Rectangle(-372,-73.4,744.1,146.9), null);
...
(lib.startcopy2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.startcopy2, new cjs.Rectangle(-194.4,-188.4,388.8,376.9), null);


(lib.middlecopy2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.middlecopy2, new cjs.Rectangle(-142.9,-144.9,285.9,289.9), null);


(lib.dartcopy2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.dartcopy2, new cjs.Rectangle(0,0,479.8,537.4), null);
...
(lib.birdframecopy = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.birdframecopy, new cjs.Rectangle(-280,-238,743.4,473.1), null);
...
(lib.bulletemojicopy2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.bulletemojicopy2, new cjs.Rectangle(-200,-310.7,476,499.79999999999995), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(644.8,597.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_7
	this.instance_1 = new lib.bulletemojicopy2();
	this.instance_1.setTransform(572.55,93.35,0.1331,0.1331,0,0,0,0.4,0.4);
	this.instance_1.shadow = new cjs.Shadow("rgba(51,51,51,1)",3,3,4);

	this.instance_2 = new lib.loopiconcopy3();
	this.instance_2.setTransform(657.85,93.55,0.1188,0.1188,0,0,0,0.8,0.8);
	this.instance_2.shadow = new cjs.Shadow("rgba(51,51,51,1)",3,3,4);

	this.instance_3 = new lib.Xwrongcopy3();
	this.instance_3.setTransform(735.95,96.05,0.0781,0.0781,0,0,0,0.7,1.9);
	...
	// Layer_9
	this.instance_4 = new lib.VizulationLogoTextOnly();
	this.instance_4.setTransform(361,17,0.1025,0.1025);
	...
	this.instance_7.setTransform(515,297,0.4305,0.4305);
	...
	// Layer_30
	this.instance_8 = new lib.birdframecopy();
