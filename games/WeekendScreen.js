...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.text = new cjs.Text("in the meantime, why don't you post your weekly results?", "40px 'Zerove'");
	this.text.textAlign = "center";
	this.text.lineHeight = 48;
	this.text.lineWidth = 570;
	this.text.parent = this;
	this.text.setTransform(362.35,556);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

	// Layer_3
	this.text_1 = new cjs.Text(" hey, it's the weekend \nso let's take a break. see you back \nhere on monday. ", "80px 'Zerove'");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 93;
	this.text_1.lineWidth = 877;
	this.text_1.parent = this;
	this.text_1.setTransform(635.05,134);

	this.timeline.addTween(cjs.Tween.get(this.text_1).wait(1));

	// Layer_2
	this.instance = new lib.bulletemoji();
	this.instance.setTransform(824.95,614.4,0.3396,0.3396,0,0,0,0.1,0.1);

	this.instance_1 = new lib.loopiconcopy();
	this.instance_1.setTransform(1008.6,605.75,0.3144,0.3144,0,0,0,0.3,0.3);

	this.instance_2 = new lib.Xwrong();
	this.instance_2.setTransform(1181.85,610.5,0.2454,0.2454,0,0,0,0.4,0.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Layer_1
	this.instance_3 = new lib.log();
	this.instance_3.setTransform(1080.6,58.7,0.7453,0.7453);
...
p.nominalBounds = new cjs.Rectangle(623.1,318.3,677.4999999999999,517);
// library properties:
lib.properties = {
