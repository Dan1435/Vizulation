...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(572.55,67.35,0.1331,0.1331,0,0,0,0.4,0.4);
	this.instance.shadow = new cjs.Shadow("rgba(51,51,51,1)",3,3,4);

	this.instance_1 = new lib.loopiconcopy2();
	this.instance_1.setTransform(657.85,67.55,0.1188,0.1188,0,0,0,0.8,0.8);
	this.instance_1.shadow = new cjs.Shadow("rgba(51,51,51,1)",3,3,4);

	this.instance_2 = new lib.Xwrong();
	this.instance_2.setTransform(735.95,70.05,0.0781,0.0781,0,0,0,0.7,1.9);
	this.instance_2.shadow = new cjs.Shadow("rgba(51,51,51,1)",3,3,4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Layer_10
	this.instance_3 = new lib.VizulationLogoTextWithTagline();
	this.instance_3.setTransform(361,-9,0.1025,0.1025);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1));

	// Layer_1
	this.instance_4 = new lib.weekend();
	this.instance_4.setTransform(648,600.1,0.7364,0.7364,0,0,0,0.1,0);
