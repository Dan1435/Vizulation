...
(lib.naturalwoodenbackground = function() {
	this.initialize(img.naturalwoodenbackground);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,5760,3840);// helper functions:
...
(lib.yellowpiece = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.lf(["#F0F223","#F0E125"],[0,1],-70.7,-70.7,70.8,70.8).s().p("AvogZIfR/NMgAJA/Ng");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.149)").s().p("AvogZIfR/NMgAJA/Ng");
	this.shape_1.setTransform(14.4,28.8);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.yellowpiece, new cjs.Rectangle(-100,-202.3,214.5,433.4), null);
...
(lib.redpiece = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#EF3D61","#EF1A62"],[0,1],-37.2,-93.1,37.3,93.2).s().p("Avjv/IfQ/NMgAKA+7I/Pfeg");
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.149)").s().p("AvjwAIfQ/NMgAKA+8I/Pffg");
	this.shape_1.setTransform(24.025,4.8);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.redpiece, new cjs.Rectangle(-100.4,-302.1,224.9,609.1), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-1.275,-38.7);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.questiontext, new cjs.Rectangle(-474.2,-190,945.9,302.7), null);
...
(lib.purplepiece = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#A796C2","#A784C2"],[0,1],-58.3,-53.7,71.5,76.1).s().p("A/KABIfN/vIfIf/I/Ofeg");
	this.shape.setTransform(0.025,0);
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.149)").s().p("A/KABIfN/wMAfIAgBI/Ofeg");
	this.shape_1.setTransform(24.025,4.8);
...
}).prototype = getMCSymbolPrototype(lib.purplepiece, new cjs.Rectangle(-199.5,-203.1,423.1,411.1), null);


(lib.purpleholepiece = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#A78BC2").s().p("A+vATIR2x1IAAAAINntoIeCe4I/Ofdg");
	this.shape.setTransform(2.7,3.6);
...
}).prototype = getMCSymbolPrototype(lib.purpleholepiece, new cjs.Rectangle(-194.1,-198.3,417.7,406.3), null);
...
(lib.pinkpieceshadow1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#F195C8","#F185CA"],[0,1],-19.8,-66.1,100.7,142.6).s().p("A/JP3IfM/tIfHftg");
	this.shape.setTransform(0.025,0);
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.149)").s().p("A81OnIcv9NIc8dNg");
	this.shape_1.setTransform(14,17.625);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.pinkpieceshadow1, new cjs.Rectangle(-199.4,-101.5,398.9,212.7), null);


(lib.pinkpieceshadow1_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#F195C8","#F185CA"],[0,1],-19.8,-66.1,100.7,142.6).s().p("A/JP3IAkgkIeo/JIe2fcMg9egATMA9eAATIARARg");
	this.shape.setTransform(0.025,0);
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.149)").s().p("A9SOtIdN9rIdYd9g");
	this.shape_1.setTransform(27.1,1.325);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.pinkpieceshadow1_1, new cjs.Rectangle(-199.4,-101.5,414,203.1), null);


(lib.pinkpiece = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.149)").s().p("A/JP4IfM/vIfHfvg");
	this.shape_1.setTransform(28.825,9.6);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.pinkpiece, new cjs.Rectangle(-199.4,-101.5,427.70000000000005,212.7), null);


(lib.orangepiece = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#F8C82C","#F8A929"],[0,1],-11.6,-89,141.6,279.9).s().p("A/PfeMA+fg+7MgAKA+7g");
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.149)").s().p("A/OfeMA+dg+7MgAJA+7g");
	this.shape_1.setTransform(19.2,14.425);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.orangepiece, new cjs.Rectangle(-199.9,-201.4,419.1,417.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-0.05,-89.625);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.instructionstext, new cjs.Rectangle(-486.7,-183,973.4,186.8), null);
...
(lib.greenpiece = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#C9E891","#C9C794"],[0,1],0,209.7,0,-209.7).s().p("Eg+egfMMB89AAAMg+hA+Zg");
	this.shape.setTransform(0.025,0);
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.149)").s().p("Eg+egfMMB89AAAMg+hA+Zg");
	this.shape_1.setTransform(35.975,-14.65);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.greenpiece, new cjs.Rectangle(-399.8,-214.3,835.7,414), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
...
}).prototype = getMCSymbolPrototype(lib.answerrevealtext, new cjs.Rectangle(-318.3,-416.6,636.7,371.70000000000005), null);


(lib.darkgreen = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#33BE05","#33B203"],[0,1],-11.6,-89,141.6,279.9).s().p("A/PfeMA+fg+7MgAKA+7g");
	this.shape.setTransform(0,0.025);
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.149)").s().p("A/PfeMA+fg+7MgAKA+7g");
	this.shape_1.setTransform(11.35,3.775);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.darkgreen, new cjs.Rectangle(-199.9,-201.4,411.20000000000005,406.6), null);


(lib.bluepieceshadow1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#68C0D2","#68B7D3"],[0,1],-83.1,134.5,94.1,-12.2).s().p("EgfNg+7MA+bA+aMg+bA/dg");
	this.shape.setTransform(0.025,0);
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.149)").s().p("EgdRg73MA6jA6iMg6jA9Ng");
	this.shape_1.setTransform(14.05,-7.925);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bluepieceshadow1, new cjs.Rectangle(-199.7,-402.8,401.2,805.7), null);


(lib.bluepiece = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.149)").s().p("EgfNg+7MA+bA+aMg+bA/dg");
	this.shape_1.setTransform(26.425,11.7);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bluepiece, new cjs.Rectangle(-199.7,-402.8,425.9,817.4000000000001), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(102,62,0,0.847)").s().p("EhqhBA+MAAAiB8MDVCAAAMAAACB8g");
	this.shape.setTransform(64,-4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_2
	this.instance = new lib.naturalwoodenbackground();
	this.instance.setTransform(-630,-482,0.2447,0.2447);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.bg, new cjs.Rectangle(-630,-482,1409.4,939.6), null);


(lib.tangrampieces = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.greenpiece();
	this.instance.setTransform(-119.1,-126.4,0.6447,0.6447,14.9974,0,0,0.1,0.2);

	this.instance_1 = new lib.bluepiece();
	this.instance_1.setTransform(-327.55,4.3,0.6447,0.6447,-23.6874,0,0,0.2,0.1);

	this.instance_2 = new lib.pinkpiece();
	this.instance_2.setTransform(-12.9,228.45,0.6447,0.6447,0,0,0,0.1,0.1);

	this.instance_3 = new lib.purplepiece();
	this.instance_3.setTransform(291.85,186.65,0.6447,0.6447,0,0,0,0.1,0.1);

	this.instance_4 = new lib.yellowpiece();
	this.instance_4.setTransform(272.2,-124.55,0.6447,0.6447,0,0,0,0.1,0.1);

	this.instance_5 = new lib.orangepiece();
	this.instance_5.setTransform(23.55,0.05,0.6447,0.6447,0,0,0,0.2,0.1);

	this.instance_6 = new lib.redpiece();
	this.instance_6.setTransform(485.3,-64.85,0.6447,0.6447,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.tangrampieces, new cjs.Rectangle(-550,-320.7,1115.5,641.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:0.8516},5,cjs.Ease.get(1)).wait(120).to({_off:true},1).wait(37));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-64.2,20.85);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.bluepiece();
	this.instance.setTransform(-56.65,686.6,0.114,0.114,0,45.1627,-134.8373);

	this.instance_1 = new lib.pinkpieceshadow1_1();
	this.instance_1.setTransform(179.1,653.5,0.4339,0.4339,-90.2962,0,0,-0.5,0.5);

	this.instance_2 = new lib.purpleholepiece();
	this.instance_2.setTransform(-39.7,634.7,0.231,0.231,45);

	this.instance_3 = new lib.yellowpiece();
	this.instance_3.setTransform(17.15,626.15,0.2983,0.2983,45,0,0,-0.4,-0.1);

	this.instance_4 = new lib.orangepiece();
	this.instance_4.setTransform(225.9,652.9,0.3039,0.3039,-45,0,0,0,0.2);

	this.instance_5 = new lib.redpiece();
	this.instance_5.setTransform(108.6,628.65,0.2341,0.2341,0,90,-90);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.key, new cjs.Rectangle(-108.3,560,427.7,180.10000000000002), null);
...
p.nominalBounds = new cjs.Rectangle(-738.1,-434.1,1476.3000000000002,1175.7);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.greenpiece();
	this.instance.setTransform(-122.1,-201.45,0.6447,0.6447,179.9986,0,0,0.1,0.1);

	this.instance_1 = new lib.bluepiece();
	this.instance_1.setTransform(138.85,62.45,0.6447,0.6447,89.8305,0,0,0.2,0.1);

	this.instance_2 = new lib.pinkpiece();
	this.instance_2.setTransform(-54.3,71.85,0.6447,0.6447,89.6976,0,0,0.2,0);

	this.instance_3 = new lib.purplepiece();
	this.instance_3.setTransform(12,204.15,0.6447,0.6447,0,0,0,0.1,0.1);

	this.instance_4 = new lib.yellowpiece();
	this.instance_4.setTransform(140.9,-273.6,0.6447,0.6447,90,0,0,0.1,0.1);

	this.instance_5 = new lib.orangepiece();
	this.instance_5.setTransform(-253.75,61.85,0.6447,0.6447,-90,0,0,0.2,0.1);

	this.instance_6 = new lib.redpiece();
	this.instance_6.setTransform(205.2,-139.25,0.6447,0.6447,-90,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.heart, new cjs.Rectangle(-403,-338.1,806.1,676.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#666666","#333333"],[0,1],4.1,-116.6,4.1,354.2).s().p("EhlhA5vMAAAhzeMDLDAAAMAAABzeg");
...
}).prototype = getMCSymbolPrototype(lib.letsseehowyoudid, new cjs.Rectangle(-617.7,-416.5,1299.5,739.1), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.darkgreen();
	this.instance.setTransform(-248.3,108.9,0.6446,0.6446,0,45,-135,0.1,0.2);

	this.instance_1 = new lib.bluepieceshadow1();
	this.instance_1.setTransform(-299.7,741.4,0.6447,0.6447,-0.1695,0,0,0.2,0.1);

	this.instance_2 = new lib.pinkpieceshadow1();
	this.instance_2.setTransform(-495.65,997.35,0.6447,0.6447,89.6976,0,0,0,0.1);

	this.instance_3 = new lib.purplepiece();
	this.instance_3.setTransform(-429.6,301.5,0.8853,0.8853,0,0,0,0.1,0.1);

	this.instance_4 = new lib.yellowpiece();
	this.instance_4.setTransform(-503.45,611.6,0.6447,0.6447,0,0,0,0,-0.1);

	this.instance_5 = new lib.orangepiece();
	this.instance_5.setTransform(-615.25,112.5,0.6446,0.6446,-44.999,0,0,0.1,0.2);

	this.instance_6 = new lib.redpiece();
	this.instance_6.setTransform(41.6,1172.6,0.6447,0.6447,-90,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Layer_3
	this.instance_7 = new lib.greenpiece();
	this.instance_7.setTransform(-250.85,1018.65,0.6446,0.6446,-45,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cat, new cjs.Rectangle(-798.3,-77.5,1037.8,1369.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.bluepiece();
	this.instance.setTransform(-1125.3,865.6,0.22,0.22,-45.1658,0,0,-0.3,0.7);

	this.instance_1 = new lib.purpleholepiece();
	this.instance_1.setTransform(-1539.65,896,0.422,0.422,45);

	this.instance_2 = new lib.yellowpiece();
	this.instance_2.setTransform(-1633.85,900.6,0.2983,0.2983,0,180,0,-0.1,-0.1);

	this.instance_3 = new lib.orangepiece();
	this.instance_3.setTransform(-1371.1,628.8,0.6446,0.6446,0,45,-135,0.1,0.2);

	this.instance_4 = new lib.redpiece();
	this.instance_4.setTransform(-1285.3,896.75,0.6144,0.6144,-90,0,0,0.1,0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Layer_3
	this.instance_5 = new lib.greenpiece();
	this.instance_5.setTransform(-1445.5,926.95,0.2074,0.2074,0,45,-135,1,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.boat, new cjs.Rectangle(-1663.6,443.6,638,581.1999999999999), null);
...
(lib.keyzoom = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(2.2,-4.05,0.9915,0.9915,0,0,0,107.7,647);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:646.9,scaleX:1.1238,scaleY:1.1238,x:2.25,y:-4.1},4,cjs.Ease.get(1)).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-240.5,-101.8,480.6,202.3);


(lib.keystill = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.keystill, new cjs.Rectangle(-211.9,-90.3,423.9,178.5), null);


(lib.keybutton = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.keystill();

	this.instance_1 = new lib.keyzoom();
...
p.nominalBounds = new cjs.Rectangle(-211.9,-90.3,423.9,178.5);


(lib.heartzoom = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(0.1,0.05,0.3941,0.3941,0,0,0,0.2,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.4473,scaleY:0.4473},4,cjs.Ease.get(1)).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-180.2,-151.2,360.5,302.4);


(lib.heartstill = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.heartstill, new cjs.Rectangle(-158.8,-133.2,317.70000000000005,266.5), null);


(lib.heartbutton = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.heartstill();
	this.instance.setTransform(0,-32);

	this.instance_1 = new lib.heartzoom();
...
p.nominalBounds = new cjs.Rectangle(-158.8,-165.2,317.70000000000005,266.5);
...
}).prototype = getMCSymbolPrototype(lib.slotanswerreveal2ndroundcopy2, new cjs.Rectangle(-679.9,-533.9,1362.6,11451.9), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
...
p.nominalBounds = new cjs.Rectangle(-680.1,-10363.4,1362.6,21449.1);


(lib.catzoom = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(-16.2,6.4,0.2446,0.2446,0,0,0,-345.9,632.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-345.8,regY:632.2,scaleX:0.2871,scaleY:0.2871},4,cjs.Ease.get(1)).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-146,-197.3,297.8,393.1);


(lib.catstill = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.catstill, new cjs.Rectangle(-126.8,-167.2,253.8,334.9), null);


(lib.catbutton = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.catstill();
	this.instance.setTransform(0,-26);

	this.instance_1 = new lib.catzoom();
...
p.nominalBounds = new cjs.Rectangle(-126.8,-193.2,253.8,334.9);


(lib.boatzoom = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(-29.6,-8.1,0.5275,0.5275,0,0,0,-1400.8,715.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-1400.5,regY:715.4,scaleX:0.5988,scaleY:0.5988,x:-29.55},4).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-187,-170.8,381.9,347.9);


(lib.boatstill = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.boatstill, new cjs.Rectangle(-168.2,-151.5,336.5,306.6), null);


(lib.boatbutton = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.boatstill();

	this.instance_1 = new lib.boatzoom();
...
p.nominalBounds = new cjs.Rectangle(-168.2,-151.5,336.5,306.6);
...
if (reversed == null) { reversed = false; }
	...
	// heart
	this.heart_button2 = new lib.heartbutton();
	this.heart_button2.name = "heart_button2";
	this.heart_button2.setTransform(24,9.65,2.8237,2.8237,0,0,0,0.1,0);
	new cjs.ButtonHelper(this.heart_button2, 0, 1, 2, false, new lib.heartbutton(), 3);

	this.timeline.addTween(cjs.Tween.get(this.heart_button2).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._3answerreveal, new cjs.Rectangle(-424.8,-457,897.1,752.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(107).to({_off:false},0).to({alpha:1},4,cjs.Ease.get(1)).to({_off:true},1).wait(1));

	// Incorrect
	this.instance_1 = new lib.slotanswerreveal2ndroundcopy2();
	this.instance_1.setTransform(-0.2,167.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(16).to({y:-459.15},10,cjs.Ease.get(-1)).to({y:-6310.3},21).to({y:-10553.45},46,cjs.Ease.get(1)).wait(18).to({_off:true},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-680.1,-11087.4,1362.6,22173.1);
...
}).prototype = getMCSymbolPrototype(lib.slotanswerrevealcopy, new cjs.Rectangle(-649.7,-536.3,1299.5,12261.699999999999), null);
...
}).prototype = getMCSymbolPrototype(lib.slotanswerreveal, new cjs.Rectangle(-649.7,-536.3,1299.5,12261.699999999999), null);


// stage content:
(lib.Tangram = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.actionFrames = [0,473,485,595,689,704,1177,1189,1283,1395];
	// timeline functions:
	...
	this.frame_473 = function() {
		this.heart_button.addEventListener("click", handleClick.bind(this));
		this.cat_button.addEventListener("click", handleClick.bind(this));
		this.key_button.addEventListener("click", handleClick.bind(this));
		this.boat_button.addEventListener("click", handleClick.bind(this));
		
		function handleClick(evt) {
		  let clickedObject = evt.currentTarget;
		
		  if (clickedObject === this.heart_button) {
		    this.gotoAndPlay(487); // Correct answer frame
		  } else {
		    this.gotoAndPlay(597); // Wrong answer frame
		  }
		}
	}
	this.frame_485 = function() {
		this.gotoAndPlay(475);
	}
	...
	this.frame_1177 = function() {
		this.heart_button2.addEventListener("click", handleClick.bind(this));
		this.cat_button2.addEventListener("click", handleClick.bind(this));
		this.key_button2.addEventListener("click", handleClick.bind(this));
		this.boat_button2.addEventListener("click", handleClick.bind(this));
		
		function handleClick(evt) {
		  let clickedObject = evt.currentTarget;
		
		  if (clickedObject === this.heart_button2) {
		    this.gotoAndPlay(1191); // Correct answer frame
		  } else {
		    this.gotoAndPlay(1285); // Wrong answer frame
		  }
		}
	}
	this.frame_1189 = function() {
		this.gotoAndPlay(1179);
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(473).call(this.frame_473).wait(12).call(this.frame_485).wait(110).call(this.frame_595).wait(94).call(this.frame_689).wait(15).call(this.frame_704).wait(473).call(this.frame_1177).wait(12).call(this.frame_1189).wait(94).call(this.frame_1283).wait(112).call(this.frame_1395).wait(2));

	// wrong
	this.instance = new lib.Wrong("synched",0,false);
	this.instance.setTransform(639.2,356.5);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1284).to({_off:false},0).to({_off:true},112).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.rewatch_btn2).wait(689).to({_off:false},0).to({_off:true},16).wait(692));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(596).to({_off:false},0).wait(16).to({y:-99.15},10,cjs.Ease.get(-1)).to({y:-5950.3},21).to({y:-9542.55},46,cjs.Ease.get(1)).to({_off:true},16).wait(692));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},486).to({state:[{t:this.instance_2}]},16).to({state:[{t:this.instance_2}]},10).to({state:[{t:this.instance_2}]},21).to({state:[{t:this.instance_2}]},46).to({state:[]},17).to({state:[{t:this.instance_3}]},594).to({state:[]},94).to({state:[]},112).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(486).to({_off:false},0).wait(16).to({y:-99.15},10,cjs.Ease.get(-1)).to({y:-5950.3},21).to({y:-8824.05},46,cjs.Ease.get(1)).to({_off:true},17).wait(801));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4}]},1).to({state:[]},143).to({state:[{t:this.instance_5}]},189).to({state:[]},126).to({state:[{t:this.instance_4}]},246).to({state:[]},143).to({state:[{t:this.instance_5}]},189).to({state:[]},126).to({state:[]},233).wait(1));

	// key
	this.instance_6 = new lib.key();
	this.instance_6.setTransform(352.95,-156.75,0.9915,0.9915,0,0,0,107.7,647);
	this.instance_6._off = true;

	this.key_button2 = new lib.keybutton();
	this.key_button2.name = "key_button2";
	this.key_button2.setTransform(350.75,601.3);
	new cjs.ButtonHelper(this.key_button2, 0, 1, 2, false, new lib.keybutton(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_6}]},1163).to({state:[{t:this.instance_6}]},13).to({state:[{t:this.key_button2}]},1).to({state:[]},13).wait(207));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(1163).to({_off:false},0).to({y:597.25},13,cjs.Ease.get(1)).to({_off:true},1).wait(220));

	// boat
	this.instance_7 = new lib.boat();
	this.instance_7.setTransform(935.05,-179.45,0.5275,0.5275,0,0,0,-1400.8,715.5);
	this.instance_7._off = true;

	this.boat_button2 = new lib.boatbutton();
	this.boat_button2.name = "boat_button2";
	this.boat_button2.setTransform(964.65,582.65);
	new cjs.ButtonHelper(this.boat_button2, 0, 1, 2, false, new lib.boatbutton(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7}]},1163).to({state:[{t:this.instance_7}]},13).to({state:[{t:this.boat_button2}]},1).to({state:[]},13).wait(207));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(1163).to({_off:false},0).to({y:574.55},13,cjs.Ease.get(1)).to({_off:true},1).wait(220));

	// cat
	this.instance_8 = new lib.cat();
	this.instance_8.setTransform(303.55,-432.75,0.2446,0.2446,0,0,0,-345.9,632.5);
	this.instance_8._off = true;

	this.cat_button2 = new lib.catbutton();
	this.cat_button2.name = "cat_button2";
	this.cat_button2.setTransform(319.75,314.85);
	new cjs.ButtonHelper(this.cat_button2, 0, 1, 2, false, new lib.catbutton(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8}]},1163).to({state:[{t:this.instance_8}]},13).to({state:[{t:this.cat_button2}]},1).to({state:[]},13).wait(207));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1163).to({_off:false},0).to({y:295.35},13,cjs.Ease.get(1)).to({_off:true},1).wait(220));

	// heart
	this.instance_9 = new lib.heart();
	this.instance_9.setTransform(915.5,-449.1,0.3941,0.3941,0,0,0,0.2,0.1);
	this.instance_9._off = true;

	this.heart_button2 = new lib.heartbutton();
	this.heart_button2.name = "heart_button2";
	this.heart_button2.setTransform(915.4,304.35);
	new cjs.ButtonHelper(this.heart_button2, 0, 1, 2, false, new lib.heartbutton(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_9}]},1163).to({state:[{t:this.instance_9}]},13).to({state:[{t:this.heart_button2}]},1).to({state:[]},13).wait(207));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1163).to({_off:false},0).to({y:272.5},13,cjs.Ease.get(1)).to({_off:true},1).wait(220));

	// Answer_Options
	this.instance_10 = new lib.optionsframe();
	this.instance_10.setTransform(611.75,-230.75,0.876,0.876);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(1163).to({_off:false},0).to({y:329.25},13,cjs.Ease.get(1)).wait(1).to({_off:true},13).wait(207));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1163).to({_off:false},0).to({_off:true},27).wait(207));

	// shapes
	this.instance_12 = new lib.tangrampieces();
	this.instance_12.setTransform(621.9,-389.35);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(859).to({_off:false},0).to({y:364.65},15,cjs.Ease.get(1)).wait(141).to({y:1096.65},15,cjs.Ease.get(1)).to({_off:true},1).wait(366));

	// bg
	this.instance_13 = new lib.bg();
	this.instance_13.setTransform(575.8,380.85);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(705).to({_off:false},0).to({_off:true},485).wait(207));

	// key
	this.instance_14 = new lib.key();
	this.instance_14.setTransform(352.95,-156.75,0.9915,0.9915,0,0,0,107.7,647);
	this.instance_14._off = true;

	this.key_button = new lib.keybutton();
	this.key_button.name = "key_button";
	this.key_button.setTransform(350.75,601.3);
	new cjs.ButtonHelper(this.key_button, 0, 1, 2, false, new lib.keybutton(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_14}]},459).to({state:[{t:this.instance_14}]},13).to({state:[{t:this.key_button}]},1).to({state:[]},13).to({state:[]},910).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(459).to({_off:false},0).to({y:597.25},13,cjs.Ease.get(1)).to({_off:true},1).wait(924));

	// boat
	this.instance_15 = new lib.boat();
	this.instance_15.setTransform(935.05,-179.45,0.5275,0.5275,0,0,0,-1400.8,715.5);
	this.instance_15._off = true;

	this.boat_button = new lib.boatbutton();
	this.boat_button.name = "boat_button";
	this.boat_button.setTransform(964.65,582.65);
	new cjs.ButtonHelper(this.boat_button, 0, 1, 2, false, new lib.boatbutton(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_15}]},459).to({state:[{t:this.instance_15}]},13).to({state:[{t:this.boat_button}]},1).to({state:[]},13).to({state:[]},910).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(459).to({_off:false},0).to({y:574.55},13,cjs.Ease.get(1)).to({_off:true},1).wait(924));

	// cat
	this.instance_16 = new lib.cat();
	this.instance_16.setTransform(303.55,-432.75,0.2446,0.2446,0,0,0,-345.9,632.5);
	this.instance_16._off = true;

	this.cat_button = new lib.catbutton();
	this.cat_button.name = "cat_button";
	this.cat_button.setTransform(319.75,314.85);
	new cjs.ButtonHelper(this.cat_button, 0, 1, 2, false, new lib.catbutton(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_16}]},459).to({state:[{t:this.instance_16}]},13).to({state:[{t:this.cat_button}]},1).to({state:[]},13).to({state:[]},910).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(459).to({_off:false},0).to({y:295.35},13,cjs.Ease.get(1)).to({_off:true},1).wait(924));

	// heart
	this.instance_17 = new lib.heart();
	this.instance_17.setTransform(915.5,-449.1,0.3941,0.3941,0,0,0,0.2,0.1);
	this.instance_17._off = true;

	this.heart_button = new lib.heartbutton();
	this.heart_button.name = "heart_button";
	this.heart_button.setTransform(915.4,304.35);
	new cjs.ButtonHelper(this.heart_button, 0, 1, 2, false, new lib.heartbutton(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_17}]},459).to({state:[{t:this.instance_17}]},13).to({state:[{t:this.heart_button}]},1).to({state:[]},13).to({state:[]},910).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(459).to({_off:false},0).to({y:272.5},13,cjs.Ease.get(1)).to({_off:true},1).wait(924));

	// Answer_Options
	this.instance_18 = new lib.optionsframe();
	this.instance_18.setTransform(611.75,-230.75,0.876,0.876);
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(459).to({_off:false},0).to({y:329.25},13,cjs.Ease.get(1)).wait(1).to({_off:true},13).wait(911));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(459).to({_off:false},0).to({_off:true},27).wait(911));

	// shapes
	this.instance_20 = new lib.tangrampieces();
	this.instance_20.setTransform(621.9,-389.35);
	this.instance_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(155).to({_off:false},0).to({y:364.65},15,cjs.Ease.get(1)).wait(141).to({y:1096.65},15,cjs.Ease.get(1)).to({_off:true},1).wait(1070));

	// bg
	this.instance_21 = new lib.bg();
	this.instance_21.setTransform(575.8,380.85);
	this.instance_21._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(1).to({_off:false},0).to({_off:true},485).wait(911));
	...
	this.timeline.addTween(cjs.Tween.get(this.play_btn).to({_off:true},1).wait(1396));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).to({_off:true},1).wait(1396));
	this.timeline.addTween(cjs.Tween.get(instance_22Filter_1).wait(1396));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(0,-10370.9,1384.4,22624);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"/images/naturalwoodenbackground.jpg", id:"naturalwoodenbackground"}
	],
	preloads: []
};
