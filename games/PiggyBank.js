...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("how many gold coins fell into the piggy bank?", "100px 'Zerove'", "#FFFFFF");
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("count how many \ngold coins fall in \nthe piggy bank.", "100px 'Zerove'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 116;
	this.text.lineWidth = 1054;
	this.text.parent = this;
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("good luck!", "200px 'Zerove'", "#FFFFFF");
	this.text.textAlign = "center";
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(6.6,-52.9863,1,1.0068);
