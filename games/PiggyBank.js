...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(651).to({_off:false},0).wait(16).to({y:-99.15},10,cjs.Ease.get(-1)).to({y:-5950.3},21).to({y:-8822.7},46,cjs.Ease.get(1)).to({_off:true},17).wait(966));
	...
	// Layer_5
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#FAA0AE").ss(0.1,1,1).p("AubBXIBzicQEtg3ExgEQIzgGIvBMIAFACIAAABIgFADIgCACIjdCzAOYg0IAFgE");
	...
	// Layer_11
	this.instance_12 = new lib.blurshade();
	this.instance_12.setTransform(594.55,419.15);
	this.instance_12._off = true;
	this.instance_12.filters = [new cjs.BlurFilter(15, 15, 1)];
	this.instance_12.cache(-346,-274,693,548);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(870).to({_off:false},0).to({_off:true},650).wait(207));
	...
	this.shape_20.graphics.f().s("#FAA0AE").ss(0.1,1,1).p("AEPIAQA8iNAqiRQAziyAJi2QAKjOhyioQi+gsivBTQhLAkhIAnQiJBMhxBtID6HBAE9n0QiOBjhzCEQhzCGhFChQgsBngPBvIHCEXIABAAIgCADQAEACAFAAIgEgMIgDAHIAHAF");
	...
	this.instance_13.setTransform(642.15,438.1);
	...
	// Layer_21
	this.instance_14 = new lib.shadowshade();
	this.instance_14.setTransform(580.8,638.3);
	this.instance_14._off = true;
	this.instance_14.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance_14.cache(-303,-67,606,134);
	...
	this.instance_15.setTransform(657.75,585.4);
	...
	this.instance_16.setTransform(452.4,279.05,0.7997,0.7997);
	this.instance_16._off = true;
	this.instance_16.filters = [new cjs.BlurFilter(10, 10, 1)];
	this.instance_16.cache(-614,-395,2086,733);
	...
	// Layer_11
	this.instance_19 = new lib.blurshade();
	this.instance_19.setTransform(594.55,419.15);
	this.instance_19._off = true;
	this.instance_19.filters = [new cjs.BlurFilter(15, 15, 1)];
	this.instance_19.cache(-346,-274,693,548);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(1).to({_off:false},0).to({_off:true},650).wait(1076));
	...
	this.instance_20.setTransform(642.15,438.1);
	...
	// Layer_21
	this.instance_21 = new lib.shadowshade();
	this.instance_21.setTransform(580.8,638.3);
	this.instance_21._off = true;
	this.instance_21.filters = [new cjs.BlurFilter(4, 4, 1)];
	this.instance_21.cache(-303,-67,606,134);
	...
	this.instance_22.setTransform(657.75,585.4);
	...
	this.instance_23.setTransform(452.4,279.05,0.7997,0.7997);
	this.instance_23._off = true;
	this.instance_23.filters = [new cjs.BlurFilter(10, 10, 1)];
	this.instance_23.cache(-614,-395,2086,733);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_24).to({_off:true},1).wait(1726));
	this.timeline.addTween(cjs.Tween.get(instance_24Filter_1).wait(1726));
