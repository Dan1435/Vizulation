...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["Shuffleboard_atlas_1"],0);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.724,0,0,0.724,-723.6,-723.6)).s().p("EhxDBxEMAAAjiHMDiHAAAMAAADiHg")
	}.bind(this);
	this.shape.setTransform(-0.375,-4.375);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.noisyalpha, new cjs.Rectangle(-724,-728,1447.3,1447.3), null);
